...
/**
 * Client site: Test Detntal Clinic
 * Registry key: test-dental
 * Generated by: npm run create:client
 */
export const testDentalConfig: SiteConfig = {
  "businessName": "Test Detntal Clinic",
  "sector": "Diş Kliniği",
  "slogan": "Temiz Dişler",
  "description": "Dişçilik",
  "contact": {
    "phone": "50505050",
    "email": "aljsdlş@email.com",
  ...
  "services": [
    {
      ...
      "description": "Kayıp dişleriniz için kalıcı, doğal görünümlü implant çözümleri.",
      "icon": "Sparkles"
    },
    {
      "id": "whitening",
      "title": "Diş Beyazlatma",
      "description": "Güvenli ve etkili profesyonel beyazlatma ile parlak bir gülüş.",
      "icon": "Sun"
    },
    {
      "id": "orthodontics",
      "title": "Ortodonti",
      "description": "Şeffaf plak ve tel tedavileriyle düzgün ve estetik diş dizilimi.",
      "icon": "AlignCenter"
    },
    {
      "id": "pediatric",
      "title": "Çocuk Diş Hekimliği",
      "description": "Çocuklara özel, konforlu ve korkusuz diş tedavi deneyimi.",
      "icon": "Heart"
    },
    {
      "id": "aesthetic",
      "title": "Estetik Diş",
      "description": "Lamina, bonding ve gülüş tasarımı ile hayalinizdeki gülüş.",
      "icon": "Smile"
    },
    {
      "id": "emergency",
      "title": "Acil Diş",
      "description": "Ağrı ve travma durumlarında aynı gün acil müdahale hizmeti.",
      "icon": "Siren"
    }
  ],
  "testimonials": [
    {
      ...
      "content": "Yıllardır ertelediğim implant tedavimi Dentavia'da tamamladım. Süreç boyunca her adım açıklandı, sonuçtan çok memnunum.",
      "rating": 5
    },
    {
      "id": "t2",
      ...
      "content": "Şeffaf plak tedavisi beklediğimden çok daha rahattı. Ekip her kontrolde ilgili ve profesyoneldi.",
      "rating": 5
    },
    {
      "id": "t3",
      "name": "Zeynep Demir",
      "role": "Estetik diş",
      "content": "Gülüş tasarımı sonrası özgüvenim arttı. Klinik hijyenik, modern ve sıcak bir ortam.",
      "rating": 5
    }
  ],
  "faqs": [
    {
      ...
      "answer": "Evet, ilk muayene ve dijital ağız içi değerlendirme randevunuz ücretsizdir. Tedavi planı bu görüşmede paylaşılır."
    },
    {
      "id": "f2",
      "question": "İmplant tedavisi ne kadar sürer?",
      "answer": "Kemik yapısına göre değişmekle birlikte çoğu vakada 3–6 ay içinde kalıcı protez tamamlanır."
    },
    {
      "id": "f3",
      "question": "Taksit imkânı var mı?",
      "answer": "Anlaşmalı bankalar ve klinik içi ödeme planları ile tedavinizi kolayca planlayabilirsiniz."
    },
    {
      "id": "f4",
      "question": "Acil durumlarda ne yapmalıyım?",
      "answer": "Mesai saatleri içinde doğrudan arayın; mesai dışında WhatsApp hattımızdan ulaşabilirsiniz."
    }
  ],
  "socialLinks": [
    {
  ...
  "sections": {
    ...
    "cta": {
      ...
      "description": "Ücretsiz ilk muayene için hemen iletişime geçin. Ekibimiz size en uygun zamanı ayarlasın.",
      "callLabel": "Hemen Ara",
      "whatsappLabel": "WhatsApp ile yazın"
    }
  },
  "seo": {
    "title": "Test Detntal Clinic | Diş Kliniği",
    "description": "Dişçilik",
    "keywords": [
